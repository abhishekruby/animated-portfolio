      ...
      <div className="h-full overflow-y-scroll no-scrollbar lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            />
            {/* BIOGRAPHY TITLE */}
            <h1 className="font-bold text-2xl text-[#fff]">BIOGRAPHY</h1>
            {/* BIOGRAPHY DESC */}
            ...
            {/* BIOGRAPHY QUOTE */}
            <span className="italic text-[#acbac9]">
          ...
          <div className="flex flex-col gap-12 justify-center text-[#fff]" ref={skillRef}>
            ...
            >
              <div className="rounded  p-2 text-base cursor-pointer text-white font-semibold ring-[#00ffff] ring-2">
                JavaScript
              </div>
              <div className="rounded  p-2 text-base cursor-pointer text-white font-semibold ring-[#00ffff] ring-2">
                TypeScript
