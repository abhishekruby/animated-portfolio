  ...
  return (
      <nav className="w-full flex justify-center gap-[15%] items-center py-4 lg:gap-12 lg:px-20 xl:gap-24 xl:px-48">
        ...
        <motion.ul
          ...
          className="flex gap-3 ring-1 ring-slate-600 bg-slate-700 rounded-full p-4 lg:flex-row lg:justify-start lg:w-1/2 xl:w-1/3"
        >
          {links.map((link) => (
            <li key={link.title} className="lg:w-1/5 xl:w-1/4">
              <NavLink link={link} />
            </li>
          ))}
        </motion.ul>
